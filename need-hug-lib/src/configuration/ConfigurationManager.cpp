...
{
	if(NeedHug::ConfigurationData::stringData.count(name) == 0) return false;
...
{
	if (NeedHug::ConfigurationData::intData.count(name) == 0) return false;
...
{
	if (NeedHug::ConfigurationData::floatData.count(name) == 0) return false;
...
{
	if (NeedHug::ConfigurationData::boolData.count(name) == 0) return false;
